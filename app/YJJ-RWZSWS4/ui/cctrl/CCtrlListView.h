...
public:
    ...
    DWORD GetLeft(DWORD index)
    {
        return m_pListItem[index].m_left;
    }
    DWORD GetWidth(DWORD index)
    {
        return m_pListItem[index].m_width;
    }
    DWORD GetTitle(DWORD index)
    {
        return m_pListItem[index].m_title;
    }
