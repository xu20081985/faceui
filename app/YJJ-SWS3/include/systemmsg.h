...
#define	MSG_SIPCALL				10011		// SIP消息
#define MSG_CALL_CREATE			0
#define	MSG_CALL_BUSY			1
#define	MSG_CALL_RING			2
#define	MSG_CALL_ACCEPT			3
#define	MSG_CALL_HANGUP			4
#define	MSG_CALL_OFFLINE		5
#define MSG_CALL_LIUYAN			6
