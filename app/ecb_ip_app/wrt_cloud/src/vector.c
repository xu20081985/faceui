...
int vector_add(vector_t *vector, void *element)
{
	...
	memcpy((void*)((unsigned char*)vector->data + (vector->element_count * vector->element_size)), 
...
int vector_remove(vector_t *vector, int index)
{
	...
	if (cnt > 0) {
		memmove((void*)((unsigned char*)vector->data + (index * vector->element_size)), 
			(void*)((unsigned char*)vector->data + ((index + 1) * vector->element_size)),
...
int vector_get(vector_t *vector, int index, void *element_dst)
{
	...
	memcpy(element_dst, (void*)((unsigned char*)vector->data + (index * vector->element_size)), vector->element_size);
...
void* vector_get_ptr(vector_t *vector, int index)
{
	...
	else return (void*) ((unsigned char*)vector->data + (index * vector->element_size));
}
