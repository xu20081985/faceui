...
#include <stdlib.h>
//#include <ortp/port.h> 	//<ziona>===

//<ziona>===begin===
/*
#define cds_malloc(s)	ortp_malloc(s)
#define cds_free(p)		ortp_free(p)
#define cds_malloc_ptr	ortp_malloc
#define cds_free_ptr	ortp_free
#define cds_malloc_pkg(s)	ortp_malloc(s)
#define cds_free_pkg(p)		ortp_free(p)
*/
//<ziona>===end===
